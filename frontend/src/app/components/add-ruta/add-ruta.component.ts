...
export class AddRutaComponent implements OnInit {
  ...
  constructor(private rutaService:RutasService, private conductoresService:ConductorService, private loginService:LoginService) { 
    this.loginService.mandarLogin()
    this.getConductores()
  }
