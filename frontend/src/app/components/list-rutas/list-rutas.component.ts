...
export class ListaRutasComponent implements OnInit {
  ...
  constructor(private rutaService:RutasService,private conductoresService:ConductorService,private smsService:SMSService,private modalService:NgbModal, private loginSevice:LoginService) {
    this.loginSevice.mandarLogin()
    this.getConductores()
    this.refreshList()
   }
  ngOnInit(): void {
